...
('11111111-1111-1111-1111-111111111111', '株式会社グリーンファーム', 'premium', 'contact@greenfarm.example.com', '03-1234-5678', '茨城県', '水戸市', 20, 100),
('22222222-2222-2222-2222-222222222222', '農業法人アグリテック', 'enterprise', 'info@agritech.example.com', '03-2345-6789', '千葉県', '千葉市', 50, 200),
('33333333-3333-3333-3333-333333333333', '田中農園', 'basic', 'tanaka@farm.example.com', '03-3456-7890', '群馬県', '前橋市', 5, 30);
...
-- ('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', '11111111-1111-1111-1111-111111111111', 'admin@greenfarm.example.com', '管理者太郎', 'admin');
...
('v1111111-1111-1111-1111-111111111111', '11111111-1111-1111-1111-111111111111', 
...
('v2222222-2222-2222-2222-222222222222', '11111111-1111-1111-1111-111111111111',
...
('v3333333-3333-3333-3333-333333333333', '11111111-1111-1111-1111-111111111111',
...
('v4444444-4444-4444-4444-444444444444', '11111111-1111-1111-1111-111111111111',
...
-- A棟トマトのタスク
('v1111111-1111-1111-1111-111111111111', '種まき', 'トマト桃太郎の種まき作業', 'seeding', 'high', 'completed', '2024-03-01', '2024-03-01', 100),
('v1111111-1111-1111-1111-111111111111', '移植', '育苗トレイから本圃場への移植', 'transplanting', 'high', 'completed', '2024-03-30', '2024-03-30', 100),
('v1111111-1111-1111-1111-111111111111', '支柱立て', '支柱とネットの設置', 'other', 'medium', 'completed', '2024-04-15', '2024-04-15', 100),
('v1111111-1111-1111-1111-111111111111', '第1回追肥', '開花期の追肥作業', 'fertilizing', 'medium', 'in_progress', '2024-05-01', '2024-05-01', 50),
('v1111111-1111-1111-1111-111111111111', '第2回追肥', '果実肥大期の追肥', 'fertilizing', 'medium', 'pending', '2024-06-01', '2024-06-01', 0),
('v1111111-1111-1111-1111-111111111111', '収穫開始', 'トマトの収穫作業開始', 'harvesting', 'high', 'pending', '2024-06-10', '2024-08-31', 0),

-- B棟キュウリのタスク
('v2222222-2222-2222-2222-222222222222', '種まき', 'キュウリ四葉の種まき', 'seeding', 'high', 'completed', '2024-03-15', '2024-03-15', 100),
('v2222222-2222-2222-2222-222222222222', '移植', 'キュウリの移植作業', 'transplanting', 'high', 'completed', '2024-04-10', '2024-04-10', 100),
('v2222222-2222-2222-2222-222222222222', 'ネット張り', 'キュウリ用ネットの設置', 'other', 'medium', 'completed', '2024-04-20', '2024-04-20', 100),
('v2222222-2222-2222-2222-222222222222', '第1回追肥', 'キュウリ第1回追肥', 'fertilizing', 'medium', 'completed', '2024-05-01', '2024-05-01', 100),
('v2222222-2222-2222-2222-222222222222', '収穫準備', '収穫用コンテナ準備', 'other', 'low', 'pending', '2024-05-18', '2024-05-20', 0),

-- 露地レタスのタスク
('v3333333-3333-3333-3333-333333333333', '畑準備', '露地圃場の耕起・施肥', 'other', 'high', 'pending', '2024-03-18', '2024-03-19', 0),
('v3333333-3333-3333-3333-333333333333', '種まき', 'レタスの直播作業', 'seeding', 'high', 'pending', '2024-03-20', '2024-03-20', 0),
('v3333333-3333-3333-3333-333333333333', '第1回間引き', 'レタスの間引き作業', 'other', 'medium', 'pending', '2024-03-30', '2024-03-30', 0),
('v3333333-3333-3333-3333-333333333333', '第2回間引き', 'レタス最終間引き', 'other', 'medium', 'pending', '2024-04-10', '2024-04-10', 0),
('v3333333-3333-3333-3333-333333333333', '追肥作業', 'レタス追肥', 'fertilizing', 'medium', 'pending', '2024-04-20', '2024-04-20', 0);

-- ====================================================================
-- 6. サンプル作業記録
-- ====================================================================
INSERT INTO operation_logs (vegetable_id, growing_task_id, date, work_type, work_notes, weather, temperature_morning, temperature_afternoon, work_hours, created_by) VALUES
('v1111111-1111-1111-1111-111111111111', 
 (SELECT id FROM growing_tasks WHERE vegetable_id = 'v1111111-1111-1111-1111-111111111111' AND name = '種まき'),
 '2024-03-01', 'seeding', 'トマト桃太郎200粒播種完了。発芽率良好の種子を使用。', '晴れ', 12.5, 18.2, 2.0, 
 (SELECT id FROM users WHERE company_id = '11111111-1111-1111-1111-111111111111' LIMIT 1)),

('v1111111-1111-1111-1111-111111111111',
 (SELECT id FROM growing_tasks WHERE vegetable_id = 'v1111111-1111-1111-1111-111111111111' AND name = '移植'),
 '2024-03-30', 'transplanting', '育苗した苗50株を本圃場に移植。株間30cm、条間40cmで配置。', '曇り', 15.8, 22.1, 3.5,
 (SELECT id FROM users WHERE company_id = '11111111-1111-1111-1111-111111111111' LIMIT 1)),

('v2222222-2222-2222-2222-222222222222',
 (SELECT id FROM growing_tasks WHERE vegetable_id = 'v2222222-2222-2222-2222-222222222222' AND name = '第1回追肥'),
 '2024-05-01', 'fertilizing', 'キュウリ専用肥料を施用。1株あたり10g。', '晴れ', 18.2, 24.8, 1.5,
 (SELECT id FROM users WHERE company_id = '11111111-1111-1111-1111-111111111111' LIMIT 1));
...
('v1111111-1111-1111-1111-111111111111', '2024-04-15', 'fertilizing', 
 'トマト第1回追肥実施。開花が始まったため、リン酸重点の肥料を選択。', '晴れ',
 '化成肥料', 'トマト専用8-8-8', 500.0, 'g',
 6.2, 65, 16.5, 23.8, 2.0, 2,
 (SELECT id FROM users WHERE company_id = '11111111-1111-1111-1111-111111111111' LIMIT 1)),

('v2222222-2222-2222-2222-222222222222', '2024-04-25', 'other',
 'キュウリの誘引作業。つるの整理とネットへの固定を実施。', '曇り',
 NULL, NULL, NULL, NULL,
 6.1, 70, 17.2, 21.5, 1.0, 1,
 (SELECT id FROM users WHERE company_id = '11111111-1111-1111-1111-111111111111' LIMIT 1));